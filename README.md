...
I built my own static site generator! I did this learning project to learn how tools like [Hugo](https://github.com/gohugoio/hugo) and [Jekyll](https://github.com/jekyll/jekyll) work, so I decided to build it (though a simpler version) from scratch.
...
I didn't know that tools like Hugo already exist (I didn't research it, tbh).
